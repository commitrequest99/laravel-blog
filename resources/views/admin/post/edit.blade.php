                  ...
                  <div class="form-group w-50">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="preview_image" id="previewImage">
                        <label class="custom-file-label" name="preview_image">Выберите изображение</label>
                      </div>
                  ...
                  <div class="form-group w-50">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" name="main_image">Выберите изображение</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text">Загрузка</span>
                      </div>
